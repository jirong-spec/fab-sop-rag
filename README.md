...
### 逐題比較（Live 實測，2026-05-12，bi-encoder reranking + cap=50）

```
ID   │ 類別                        │ Graph RAG (R=檢索 A=回答)  │ Baseline RAG               │  Graph  │  Base
─────┼─────────────────────────────┼────────────────────────────┼────────────────────────────┼─────────┼────────
q01  │ anomaly_handling            │ R✅ A✅ 2/2               │ R✅ A✅ 2/2               │  3475ms │  1662ms
q02  │ sop_step_sequence  [↑HOP]   │ R✅ A✅ 4/4               │ R❌ A❌ 0/4               │  4741ms │   456ms
q03  │ equipment_precondition      │ R✅ A✅ 4/4               │ R✅ A⚠  3/4               │  3041ms │  1258ms
q04  │ step_dependency             │ R✅ A⚠  2/3               │ R✅ A✅ 3/3               │  2698ms │  1810ms
q05  │ cross_doc_dependency [↑HOP] │ R✅ A✅ 2/2               │ R✅ A✅ 2/2               │  4472ms │  1066ms
q06  │ interlock_condition         │ R✅ A⚠  1/3               │ R✅ A⚠  1/3               │  3721ms │  3162ms
q07  │ vent_procedure      [↑HOP]  │ R✅ A⚠  1/2               │ R❌ A❌ 0/2               │  2854ms │   440ms
q08  │ off_topic_blocked           │ ✅ blocked                │ ✅ blocked                │   576ms │   576ms
q09  │ off_topic_blocked           │ ✅ blocked                │ ✅ blocked                │   597ms │   597ms
q10  │ pump_check_sequence         │ R✅ A✅ 4/4               │ R❌ A❌ 0/4               │  3951ms │  1380ms
─────┼─────────────────────────────┼────────────────────────────┼────────────────────────────┼─────────┼────────
     │ TOTALS                      │ R:24/24(100%) A:20/24(83%) │ R:14/24(58%) A:11/24(46%)  │ avg 3012ms │ avg 1240ms
```
...
| **Answer 命中率**（有回答對） | **83.3%** (20/24) | 45.8% (11/24) | **+37.5 pp** |
| **多跳查詢 Answer 命中率** | **87.5%** (7/8) | 25.0% (2/8) | **+62.5 pp** |
| **正確攔截非 SOP 問題** | 2/2 | 2/2 | — |
| **平均端對端延遲** | 3012 ms | 1240 ms | +1772 ms |

> 以上數字為 Live 實測（Neo4j + vLLM Qwen2.5-3B + Chroma 全服務啟動，2026-05-12），Graph RAG 採用 bi-encoder cosine reranking + cap=50。Answer 命中率以 **answer 欄位**計算，R 命中率以 **model_triples**（模型實際收到的 triples）計算。評測關鍵字為語意實體（移除 schema 術語如 FIRST_STEP、PRECONDITION 等）。
...
- **Answer 83.3%**：相比無 reranking 的 70.8%，提升 +12.5 pp；多跳查詢從 75% → 87.5%（+12.5 pp）。
- **Generation 是剩餘瓶頸**：q06 partial（R✅ A⚠ 1/3）、q04 partial（A⚠ 2/3）屬 3B 模型無法完整引用複雜屬性（interlock ID、RF 動作）的 generation 失敗，換用 7B 以上模型預期可改善。
